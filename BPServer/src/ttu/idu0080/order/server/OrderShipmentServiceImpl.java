...
@javax.jws.WebService(
                      ...
                      wsdlLocation = "file:/home/raigo/Dokumendid/veebiteenused/src/BPServer/WebContent/order_shipments_1.wsdl",
...
public class OrderShipmentServiceImpl implements OrderShipmentService {
    ...
    public java.util.List<ttu.idu0080.order.server.OrderShipment> getOrderShipmentsByOrderIdRyhmName(int orderId,java.lang.String ryhmName) { 
        ...
        try {
            ...
            _returnVal1.setApproxDeliveryDate(javax.xml.datatype.DatatypeFactory.newInstance().newXMLGregorianCalendar("2017-03-24T16:37:56.227+02:00"));
            _returnVal1.setCourierName("CourierName2117484308");
            _returnVal1.setOrder(-1421680213);
            _returnVal1.setOrderShipment(-143432675);
            _returnVal1.setRyhmName("RyhmName499408047");
            _returnVal1.setShippingPrice(0.7862837632196612);
            _returnVal1.setTrackingNumber("TrackingNumber-670279060");
