...
public class OrderShipmentServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/raigo/Dokumendid/veebiteenused/src/BPServer/WebContent/order_shipments_1.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderShipmentServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/raigo/Dokumendid/veebiteenused/src/BPServer/WebContent/order_shipments_1.wsdl");
        }
        WSDL_LOCATION = url;
    }
