...
public class OrderServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/BPServer/services/OrderServicePort?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/BPServer/services/OrderServicePort?wsdl");
        }
        WSDL_LOCATION = url;
    }
